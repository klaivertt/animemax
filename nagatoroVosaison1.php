...
<body>
    ...
    <section class="films-et-series">
        <div class="vidéo-conteneur">
            <iframe src="https://uqload.co/embed-ylur3kx51b33.html" frameborder="0" allowfullscreen></iframe>
        </div>
        <footer>
            <div class="colonnes">
                <div class="colonne">
    ...
    <script>
        ...
        function changeEpisode(episodeUrl) {
            ...
            videoContainer.innerHTML = `<iframe class='vidéo' src="${episodeUrl}" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>`;
        }
    </script>
</body>
</html>
